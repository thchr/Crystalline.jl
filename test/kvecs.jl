...
@testset "KVec" begin
    ...
    @test string(KVec("-0.3,0.2,-.1")) == "[-0.3, 0.2, -0.1]"

    @test string(KVec("α, 2α, 0.0")) == string(KVec("α, 2.0α, 0.0")) == "[α, 2.0α, 0.0]"
    @test string(KVec("α, 2α+2, 0.0")) == string(KVec("α, 2.0α+2.0, 0.0")) == "[α, 2.0+2.0α, 0.0]"
end